...
Debugging Safari and Firefox on iOS
-------------
...
Debugging Safari and Firefox on iOS is possible through the use of the following open source libraries that come bundled with this extension:
