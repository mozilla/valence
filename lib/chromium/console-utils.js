...
function* JSPropertyProvider(aActor, aObj, aInputValue, aCursor)
{
  ...
  if (lastDot > 0 &&
    ...
    return yield getMatchedProps(values.grip(handle, aActor), matchProp);
  }
  ...
  if (obj.handle.type != "object") {
    return yield getMatchedProps(obj, matchProp);
  }
